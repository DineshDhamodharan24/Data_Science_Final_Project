    ...
    if selected == "Prediction":
        with st.form(key='my_form'):
            ...
            for i in ["transactionRevenue","num_interactions","count_hit","historic_session_page","time_on_site","avg_session_time","avg_session_time_page","historic_session","visits_per_day"]:
                if submit_button :
                    with open(r"C:\Users\dines\Desktop\final project\Model.pkl", 'rb') as file:
                        loaded_model = pickle.load(file)
                    with open(r"C:\Users\dines\Desktop\final project\Scaler.pkl", 'rb') as f:
                        scaler_loaded = pickle.load(f)
                    with open(r"C:\Users\dines\Desktop\final project\ct.pkl", 'rb') as f:
...
if selected == "PRODUCT RECOMMENDATION-SYSTEM":
    ...
    data = pd.read_csv("C:/Users/dines/Desktop/final project/amazon_product.csv")
...
if selected == "PROFILE":
    ...
    with col1:
        ...
        for _ in range(3):
            st.write(" ")
        st.markdown("### :orange[Name:  ] :blue[Dinesh Dhamodharan]")
    ...
    with col2:
        ...
        for _ in range(3):
            st.write(" ")
        st.markdown("### :orange[Email: dineshrock9600@gmail.com] ")
